...
export default function AboutPage() {
  return (
    <div className="bg-white text-gray-700 font-inter">
      {/* Hero Section */}
      <section className="relative w-full h-[60vh] flex items-center justify-center bg-[#f9f7f1]">
        ...
        <h1 className="relative z-10 text-4xl md:text-6xl font-playfair text-[#C99A3D] text-center">
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        <h2 className="text-3xl md:text-4xl font-playfair text-[#C99A3D] mb-6 text-center">
          Who We Are
        </h2>
      ...
      {/* Mission & Vision */}
      <section className="bg-[#f9f7f1] py-12 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h3 className="text-2xl font-playfair text-[#C99A3D] mb-4">
              Our Mission
            </h3>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <h2 className="text-3xl md:text-4xl font-playfair text-[#C99A3D] text-center mb-12">
          Our Core Values
        </h2>
        <div className="grid md:grid-cols-3 gap-10 text-center">
          <div className="p-6 border rounded-xl shadow-sm bg-white hover:shadow-lg transition">
            <h4 className="text-xl font-semibold mb-4 text-[#C99A3D]">
              Authenticity
            </h4>
      ...
      {/* Meet Our Team */}
      <section className="bg-[#f9f7f1] py-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-playfair text-[#C99A3D] mb-12">
            Meet Our Team
          </h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-10">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition">
              ...
              <h4 className="text-xl font-semibold text-[#C99A3D]">Dr. Ananya Sharma</h4>
              <p className="text-gray-600">Founder & Ayurvedic Expert</p>
            </div>
            {/* Team Member 2 */}
            <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition">
              <div className="relative w-32 h-32 mx-auto mb-4">
              ...
              <h4 className="text-xl font-semibold text-[#C99A3D]">Rajesh Kumar</h4>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition">
              ...
              <h4 className="text-xl font-semibold text-[#C99A3D]">Priya Desai</h4>
              <p className="text-gray-600">Marketing & Community</p>
            </div>
          </div>
        </div>
      </section>
