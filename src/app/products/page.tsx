...
export default function ProductsPage() {
  return (
    <div className="py-16 px-6 md:px-12 lg:px-20 bg-[#F9F6F1]">
      <h1 className="text-3xl md:text-4xl font-playfair text-[#5D623C] text-center mb-10">
        Our Ayurvedic Products
      </h1>
      <p className="text-center text-[#777] max-w-2xl mx-auto mb-12 font-inter">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
        {products.map((product) => (
          ...
          >
            <div className="bg-[#f9f6f167] rounded-2xl p-5 hover:shadow-xl transition-all duration-300 h-full">
              ...
              <h2 className="text-xl font-semibold text-[#5D623C] font-playfair mb-2">
                {product.name}
              </h2>
              <p className="text-sm text-[#777] font-inter mb-3">
                {product.description}
              </p>
              <p className="text-lg font-bold text-[#C99A3D] mb-4">
                {product.price}
              </p>
              ...
              <div className="md:opacity-100 lg:opacity-0 lg:group-hover:opacity-100 lg:transform lg:translate-y-4 lg:group-hover:translate-y-0 transition-all duration-300">
                <div className="inline-block bg-[#C99A3D] text-white px-5 py-2 rounded-lg font-inter hover:bg-[#a87e2f] transition text-center w-full">
                  View Details
                </div>
              </div>
            </div>
